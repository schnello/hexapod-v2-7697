...
def path_generator():
    ...
    rpath = semicircle2_generator(g_steps, y_radius, z_radius, x_radius,reverse=True)
    lpath = semicircle2_generator(g_steps, y_radius, z_radius, -x_radius,reverse=True)
